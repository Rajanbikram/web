  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <a href="#" className={activePage === 'activity'  ? 'active' : ''} onClick={(e) => handleClick(e, 'activity',  'Activity Reports')}>{navItems[4].icon} Activity Reports</a>
        <a href="#" className={activePage === 'settings'  ? 'active' : ''} onClick={(e) => handleClick(e, 'settings',  'Settings')}>{navItems[5].icon} Settings</a>
      </nav>
